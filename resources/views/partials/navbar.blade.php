<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{ ($title === "Simple Blog with Laravel") ? "active" : "" }}" aria-current="page" href="/">Home</a>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        @else
            <li class="nav-item">
              <a href="/login" class="nav-link {{ ($title === "Log In") ? "active" : "" }}"><i class="bi bi-box-arrow-in-right"></i> Log In</a>
            </li>
            <li class="nav-item">
