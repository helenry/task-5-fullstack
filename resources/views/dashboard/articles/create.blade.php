  ...
  <div class="col-lg-8">
    <form method="POST" action="/dashboard/articles">
      ...
      <div class="mb-3">
        ...
        <input required type="text" class="form-control @error ("slug") is-invalid @enderror" id="slug" name="slug" value="{{ old("slug") }}">
        @error ("slug")
          <div class="invalid-feedback mb-2">
            {{ $message }}
          </div>
      ...
      <button type="submit" class="btn btn-primary mb-5">Publish Article</button>
    </form>
  </div>
